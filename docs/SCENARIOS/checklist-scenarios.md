...
- [x] Order materials and schedule deliveries
- [x] Set up temporary living arrangements if needed
- [x] Notify neighbors about construction schedule
- [x] Purchase construction insurance
- [x] Create emergency contact list
- [x] Schedule waste removal
